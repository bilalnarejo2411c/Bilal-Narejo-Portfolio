document.addEventListener('DOMContentLoaded', function() {
    ...
    const skills = [
        ...
        {"name": "CSS", "percentage": 80, "icon": "devicon-css3-plain colored"},
        {"name": "JavaScript", "percentage": 90, "icon": "devicon-javascript-plain colored"},
        {"name": "Angular", "percentage": 70, "icon": "devicon-angular-plain-wordmark colored"},
        ...
        {"name": "Talwind Css", "percentage": 50, "icon": "devicon-tailwindcss-plain colored"},
        {"name": "GitHub", "percentage": 90, "icon": "devicon-github-plain colored"},
        {"name": "PHP", "percentage": 10, "icon": "devicon-php-plain colored"},
        {"name": "VisualCode", "percentage": 60, "icon": "devicon-vscode-plain colored"},
        {"name": "VisualStudio", "percentage": 70, "icon": "devicon-visualstudio-plain colored"},
        ...
        {"name": "My SQL", "percentage": 90, "icon": "devicon-mysql-plain-wordmark colored"},
         {"name": "XML", "percentage": 80, "icon": "devicon-xml-plain colored"},
            {"name": "Json", "percentage": 70, "icon": "devicon-json-plain colored"},
             {"name": "Jquery", "percentage": 80, "icon": "devicon-jquery-plain colored"},
    ...
    const tools = [
        ...
        {"name": "Angular", "icon": "devicon-angular-plain-wordmark colored"},
    ...
    const socialLinks = [
        ...
        {"platform": "Facebook", "icon": "fab fa-facebook-f", "link": "https://www.facebook.com/teefa.hon.yawr"},
        // {"platform": "Twitter", "icon": "fab fa-twitter", "link": "https://twitter.com/DJJonnas85"},
        {"platform": "LinkedIn", "icon": "fab fa-linkedin-in", "link": "https://www.linkedin.com/in/m-bilal-narejo-72230a361/"},
        {"platform": "Instagram", "icon": "fab fa-instagram", "link": "https://www.instagram.com/maibilalhon/"},
  ...
  const animateSkillBars = () => {
    ...
    flipCards.forEach(card => {
        ...
        // For mouse devices - flip on hover
        ...
        card.addEventListener('touchstart', (e) => {
            e.preventDefault(); // prevent double trigger with mouse events on some devices
